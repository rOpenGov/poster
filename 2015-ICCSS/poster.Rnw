...
#                           panel.grid.major = element_line(colour = 'Grey80', size = .5, linetype = 'solid'),
  ...
  The map above shows \textit{disposable incomes of private households at NUTS2 level regions in European Union in 2011}. This poster, including the Eurostat analysis example above, is fully reproducible. Download the full source code at \textcolor{blue}{\url{https://github.com/ropengov/poster}}
