...
This poster, including the Eurostat analysis example, is fully reproducible. Download the full source code at \textcolor{blue}{\url{https://github.com/rOpenGov/poster/2015-ICCSS/code/blob/master/eurostat_map.R}}
