...
#                           panel.grid.major = element_line(colour = 'Grey80', size = .5, linetype = 'solid'),
  ...
  @
  \textbf{Figure 1} In this picture a lot of things happens!
  \vspace{10mm}
  %\end{figure}
...
This poster, including the Eurostat analysis example, is fully reproducible. Download the full source code at \textcolor{blue}{\url{https://github.com/rOpenGov/poster/blob/master/2015-ICCSS/code/eurostat_map.R}}
